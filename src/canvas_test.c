...
static void test_fill_bg(FtkDisplay* display)
{
	...
	ftk_style_fill_background(thiz, 120, 10, 40, 60, bitmap);
	
	ftk_style_fill_background(thiz, 10, 80, 20, 20, bitmap);
	ftk_style_fill_background(thiz, 30, 80, 40, 20, bitmap);
	ftk_style_fill_background(thiz, 80, 80, 60, 20, bitmap);
	rect.width = width;
	rect.height = height;
